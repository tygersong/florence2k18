...
$('.zoomIn').on("click", function () {
	...
	if ((Y == 7020 && X == 10080) || (Y == 3900 && X == 1440) || (Y == 4680 && X == 4320) || (Y == 6240 && X == 7200) || (Y == 7020 && X == 11520)) {
			$(".bottom").hide();
		}

	if ((Y == 1560 && (X == 2880 || X == 1440)) || (Y == 2340 && X == 11520)) {
			$(".top").hide();
		}

	if ((Y == 1560 && X == 1440) || (Y == 5460 && X == 5760)) {
			$(".left").hide();
		}

	if ((Y == 2340 && X == 0) || (Y == 780 && X == 4320)) {
			$(".top").hide();
			$(".left").hide();
		}

	if ((Y == 3900 && X == 0) || (Y == 4680 && X == 2880) || (Y == 6240 && X == 5760) || (Y == 7020 && X == 8640)){
			$(".bottom").hide();
			$(".left").hide();
		}
	...
	if (((Y == 5460 || Y == 4680) && X == 12960) || (Y == 6240 && X == 12960) || (Y == 3900 && X == 12960) || (Y == 3120 && X == 12960)) {
			$(".right").hide();
		}

	if ((Y == 2340 && X == 12960) || (Y == 1560 && X == 10080) || (Y == 780 && X == 8640) || (Y == 0 && X == 7200)) {
			$(".top").hide();
			$(".right").hide();
		}
})
